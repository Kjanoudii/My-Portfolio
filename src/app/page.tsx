  ...
  const projects: ProjectProps[] = [
    {
      ...
      description: `DSRPT is a full-stack marketing website and custom CMS built for a leading digital marketing agency in Kuwait. It combines a high-performance public-facing website with a fully customized Filament admin panel, allowing the client to manage content without touching code. Features include dynamic blog articles with markdown rendering, auto-generated table of contents, read time estimation, related posts, author profiles, and tag-based filtering powered by MySQL and Eloquent ORM. The CMS manages blog posts, authors, case studies, team members, services, contact submissions with read/unread tracking, newsletter subscribers, and tags, alongside role-based access control restricted to verified company email domains. Additional features include XML sitemap generation, JSON-LD structured SEO data, Open Graph meta tags, Google Maps integration, and a responsive UI built with Tailwind CSS 4 and a custom design system. The project demonstrates my ability to architect, build, and deploy a production-ready Laravel application end-to-end.`,
    },
    {
      img: portfolio.src,
