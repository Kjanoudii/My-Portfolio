  ...
  const projects: ProjectProps[] = [
    {
      ...
      description: `DSRPT is a full-stack marketing website and content management system built for Kuwait's leading digital marketing agency. The project delivers a high-performance public-facing site paired with a fully custom Filament admin panel, giving the client complete control over content without touching code. The public site features dynamic blog articles with markdown rendering, auto-generated table of contents, read time estimation, related posts, author profiles, and tag-based filtering — all powered by a MySQL database with Eloquent ORM. The CMS covers blog posts, authors, case studies, team members, services, contact submissions with read/unread tracking, newsletter subscribers, and a tag management system. The admin panel uses role-based access control, restricting panel access to verified company email domains. Additional features include a dynamic XML sitemap, structured JSON-LD data for SEO, Open Graph meta tags, Google Maps integration, and full legal pages. The UI is built entirely with Tailwind CSS 4 using a custom design token system and Montserrat typography, delivering a pixel-accurate, responsive experience across all devices. This project demonstrates my ability to architect and ship a production-ready Laravel application end-to-end — from database schema and Eloquent models through to Blade templating, a fully operational admin panel, and real-world client deployment.`,
    },
    {
      img: portfolio.src,
